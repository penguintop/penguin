...
func (c *clefSigner) SignXwcData(data []byte) ([]byte, error) {
	return nil, nil
}

func (c *clefSigner) CompressedPubKeyHex() (string, error) {
	return "", nil
}

func (c *clefSigner) SignXwcTx(transaction *xwcfmt.Transaction, chainID string) (*xwcfmt.Transaction, error) {
	return nil, nil
}
...
func (c *clefSigner) XwcAddress() (common.Address, error) {
	return c.account.Address, nil
}
