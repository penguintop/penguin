...
type backendMock struct {
	...
	transactionReceipt func(ctx context.Context, txHash common.Hash) (*xwctypes.RpcTransactionReceipt, error)
	pendingNonceAt     func(ctx context.Context, account common.Address) (uint64, error)
	transactionByHash  func(ctx context.Context, hash common.Hash) (tx *xwctypes.RpcTransaction, isPending bool, err error)
...
func (m *backendMock) RefBlockInfo(ctx context.Context) (uint16, uint32, error) {
	return 0, 0, nil
}

func (m *backendMock) SendXwcTransaction(ctx context.Context, tx *xwcfmt.Transaction) (common.Hash, error) {
	return common.Hash{}, nil
}

func (m *backendMock) InvokeContractOffline(ctx context.Context, account common.Address, api string, arg string) (string, error) {
	return "", errors.New("not implemented")
}

func (m *backendMock) IsLocked(ctx context.Context) (bool, error) {
	return false, errors.New("not implemented")
}

func (m *backendMock) GetAccount(ctx context.Context, acctName string) (xwctypes.RpcAccountJson, error) {
	return xwctypes.RpcAccountJson{}, errors.New("not implemented")
}

func (m *backendMock) CreateAccount(ctx context.Context, acctName string) (string, error) {
	return "", errors.New("not implemented")
}

func (m *backendMock) BlockByNumber(ctx context.Context, number *big.Int) (*xwctypes.RpcBlock, error) {
...
func (m *backendMock) TransactionReceipt(ctx context.Context, txHash common.Hash) (*xwctypes.RpcTransactionReceipt, error) {
...
func (m *backendMock) TransactionByHash(ctx context.Context, hash common.Hash) (tx *xwctypes.RpcTransaction, isPending bool, err error) {
...
func WithTransactionReceiptFunc(f func(ctx context.Context, txHash common.Hash) (*xwctypes.RpcTransactionReceipt, error)) Option {
	return optionFunc(func(s *backendMock) {
		s.transactionReceipt = f
	})
}

func WithTransactionByHashFunc(f func(ctx context.Context, txHash common.Hash) (*xwctypes.RpcTransaction, bool, error)) Option {
	return optionFunc(func(s *backendMock) {
