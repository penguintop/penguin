...
type simulatedBackend struct {
	...
	receipts map[common.Hash]*xwctypes.RpcTransactionReceipt
...
func (m *simulatedBackend) RefBlockInfo(ctx context.Context) (uint16, uint32, error) {
	return 0, 0, nil
}

func (m *simulatedBackend) SendXwcTransaction(ctx context.Context, tx *xwcfmt.Transaction) (common.Hash, error) {
	return common.Hash{}, nil
}

func (m *simulatedBackend) InvokeContractOffline(ctx context.Context, account common.Address, api string, arg string) (string, error) {
	return "", errors.New("not implemented")
}

func (m *simulatedBackend) IsLocked(ctx context.Context) (bool, error) {
	return false, errors.New("not implemented")
}

func (m *simulatedBackend) GetAccount(ctx context.Context, acctName string) (xwctypes.RpcAccountJson, error) {
	return xwctypes.RpcAccountJson{}, errors.New("not implemented")
}

func (m *simulatedBackend) CreateAccount(ctx context.Context, acctName string) (string, error) {
	return "", errors.New("not implemented")
}

func (m *simulatedBackend) BlockByNumber(ctx context.Context, number *big.Int) (*xwctypes.RpcBlock, error) {
...
func New(options ...Option) transaction.Backend {
	m := &simulatedBackend{
		receipts: make(map[common.Hash]*xwctypes.RpcTransactionReceipt),
...
func (m *simulatedBackend) TransactionReceipt(ctx context.Context, txHash common.Hash) (*xwctypes.RpcTransactionReceipt, error) {
...
func (m *simulatedBackend) TransactionByHash(ctx context.Context, hash common.Hash) (tx *xwctypes.RpcTransaction, isPending bool, err error) {
