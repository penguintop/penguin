...
type transactionServiceMock struct {
	...
	waitForReceipt       func(ctx context.Context, txHash common.Hash) (receipt *xwctypes.RpcTransactionReceipt, err error)
	watchSentTransaction func(txHash common.Hash) (chan xwctypes.RpcTransactionReceipt, chan error, error)
...
func (m *transactionServiceMock) WaitForReceipt(ctx context.Context, txHash common.Hash) (receipt *xwctypes.RpcTransactionReceipt, err error) {
...
func (m *transactionServiceMock) WatchSentTransaction(txHash common.Hash) (<-chan xwctypes.RpcTransactionReceipt, <-chan error, error) {
...
func WithWaitForReceiptFunc(f func(ctx context.Context, txHash common.Hash) (receipt *xwctypes.RpcTransactionReceipt, err error)) Option {
	return optionFunc(func(s *transactionServiceMock) {
		s.waitForReceipt = f
	})
}
