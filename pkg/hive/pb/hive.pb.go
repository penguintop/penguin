...
type Peers struct {
	Peers []*PenAddress `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
}
...
func (m *Peers) GetPeers() []*PenAddress {
	if m != nil {
		return m.Peers
	}
	return nil
...
func (m *PenAddress) Reset()         { *m = PenAddress{} }
func (m *PenAddress) String() string { return proto.CompactTextString(m) }
func (*PenAddress) ProtoMessage()    {}
func (*PenAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_d635d1ead41ba02c, []int{1}
}
func (m *PenAddress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PenAddress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PenAddress.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PenAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PenAddress.Merge(m, src)
}
func (m *PenAddress) XXX_Size() int {
	return m.Size()
}
func (m *PenAddress) XXX_DiscardUnknown() {
	xxx_messageInfo_PenAddress.DiscardUnknown(m)
}

var xxx_messageInfo_PenAddress proto.InternalMessageInfo

func (m *PenAddress) GetUnderlay() []byte {
	if m != nil {
		return m.Underlay
	}
	return nil
...
func (m *PenAddress) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *PenAddress) GetOverlay() []byte {
	if m != nil {
		return m.Overlay
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PenAddress)(nil), "hive.PenAddress")
}
...
func (m *PenAddress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PenAddress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PenAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Peers) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Peers = append(m.Peers, &PenAddress{})
...
func (m *PenAddress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PenAddress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PenAddress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
