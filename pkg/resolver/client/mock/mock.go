...
type Client struct {
	isConnected    bool
	endpoint       string
	defaultAddress penguin.Address
	resolveFn      func(string) (penguin.Address, error)
}
...
func WitResolveAddress(addr penguin.Address) Option {
	return func(cl *Client) {
...
func WithResolveFunc(fn func(string) (penguin.Address, error)) Option {
	return func(cl *Client) {
		cl.resolveFn = fn
	}
}
...
func (cl *Client) Resolve(name string) (penguin.Address, error) {
	if cl.resolveFn == nil {
