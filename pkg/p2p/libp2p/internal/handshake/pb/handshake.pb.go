...
type Ack struct {
	Address        *PenAddress `protobuf:"bytes,1,opt,name=Address,proto3" json:"Address,omitempty"`
...
func (m *Ack) GetAddress() *PenAddress {
	if m != nil {
		return m.Address
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PenAddress)(nil), "handshake.PenAddress")
}
